...
function createProjectFromVenia({ fs, tasks, options }) {
    ...
    return {
        after({ options }) {
            // The ced-concept directory doesn't have its own babel.config.js
        ...
        visitor: {
            ...
            'package.json': ({
                ...
                const pkg = {
                    ...
                    private: true,
                    version: '0.0.1',
                    description: 'A new project based on @magento/ced-concept',
                    author,
                    license: 'UNLICENSED',
                    scripts: {}
                };
                ...
                // The ced-concept template is part of the monorepo, which
